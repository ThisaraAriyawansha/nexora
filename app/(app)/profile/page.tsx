...
export default function ProfilePage() {
  ...
  return (
    <div className="p-4 sm:p-8">
      <div className="mb-6">
        <h1 className="font-prata text-2xl text-ink">My Profile</h1>
        ...
        <div className="lg:col-span-3">
          <div className="nexora-card p-4 sm:p-6">
            ...
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-prata text-sm text-ink">Profile Info</h2>
            </div>
        ...
        <div className="lg:col-span-2 flex flex-col gap-6">
          ...
          <div className="nexora-card p-4 sm:p-6">
            <div className="flex items-center gap-2 mb-1">
              ...
              <h2 className="font-prata text-sm text-ink">Change Email</h2>
            </div>
          ...
          <div className="nexora-card p-4 sm:p-6">
            <div className="flex items-center gap-2 mb-4">
              ...
              <h2 className="font-prata text-sm text-ink">Change Password</h2>
            </div>
